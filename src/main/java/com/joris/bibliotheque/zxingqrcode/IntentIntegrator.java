...
package com.joris.bibliotheque.zxingqrcode;
...
public class IntentIntegrator {
    ...
    private void initializeConfiguration() {
        title = this.activity.getString(R.string.zxing_title);
        message = this.activity.getString(R.string.zxing_message);
        buttonYes = this.activity.getString(R.string.zxing_yes);
        buttonNo = this.activity.getString(R.string.zxing_no);
      /*title = DEFAULT_TITLE;
